...
# Add the src directory to the path to import the team name mapping
...
def main():
    ...
    # Paths
    input_path = os.path.join(script_dir, "transfermarkt_data", "games.csv")
    output_path = os.path.join(script_dir, "data", "target_variables.csv")
