...
def main():
    ...
    # Set up output path - FIXED: go up TWO levels to reach project root
    script_dir = os.path.dirname(os.path.abspath(__file__))  # /project/1_player_stats
    project_dir = os.path.dirname(script_dir)  # /project
    # If you need to go up one more level, use: os.path.dirname(project_dir)

    output_path = os.path.join(project_dir, "data", "lineups.csv")
