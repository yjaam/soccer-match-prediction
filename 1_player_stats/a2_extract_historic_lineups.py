...
# Fix the import path for the resolver function
...
print(f"Successfully imported resolve_team_name from src/")

warnings.filterwarnings('ignore')

# Define paths
TRANSFERMARKT_DIR = PROJECT_DIR / "transfermarkt_data"
...
# Remove the unused src_dir line - it was causing confusion
# src_dir = Path(__file__).resolve().parent / "src"  # DELETE THIS LINE
