...
def main():
    ...
    # Paths
    input_path = os.path.join(script_dir, "data", "data_before_pca.csv")
    target_vars_path = os.path.join(script_dir, "data", "target_variables.csv")
    output_path = os.path.join(script_dir, "data", "player_group_pca.csv")
